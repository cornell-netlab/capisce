(* test.FabricIPv4DoNotOVerrideInfraTest *)
open Runtime
...
let test_0 = [
               ...
               matches = [{ field_id = 1;
                          ...
                          { field_id = 2;
                            match_key = Ternary { value = Bigint.of_int 43521;
                                                  mask = Bigint.of_string "2522015791327477538" } }];
  ...
  TableEntry { table_id = 41754650;
               ...
               action = Action { action_id = 19792090;
                                 args = [ { arg_id = 1;
                                            value = Bigint.of_int 400 } ]};
               priority = -1};

  TableEntry { table_id = 48011802;
               matches = [{ field_id = 1;
                            match_key = Exact { value = Bigint.of_int 400 } }];
  ...
  TableEntry { table_id = 47960972;
               matches = [{ field_id = 1;
                            match_key = Exact { value = Bigint.of_int 401 } }];
               action = Profile { action_profile_member_id = 2 };
               priority = -1};

TableEntry { table_id = 44104738;
             matches = [{ field_id = 13;
                          match_key = Ternary { value = Bigint.one;
                                                mask = Bigint.of_int 3 } } ;
                        { field_id = 6;
                          match_key = Ternary { value = Bigint.of_int 167772417;
                                                mask = Bigint.of_int 4294967295 } } ;
                        { field_id = 7;
                          match_key = Ternary { value = Bigint.of_int 167772673;
                                                mask = Bigint.of_int 4294967295 } } ;
                        { field_id = 8;
                          match_key = Ternary { value = Bigint.of_int 6;
                                                mask = Bigint.of_int 255 } }];
             action = Action { action_id = 23623126;
                               args = [ { arg_id = 1;
                                          value = Bigint.of_int 401 } ] };
             priority = 10 };
]
...
let test_1 = [
  ...
  TableEntry { table_id = 44104738;
               matches = [{ field_id = 13;
                            match_key = Ternary { value = Bigint.of_int 1;
                                                  mask = Bigint.of_int 3 } } ;
                          { field_id = 6;
                            match_key = Ternary { value = Bigint.of_int 167772417;
                                                  mask = Bigint.of_int 4294967295 } } ;
                          { field_id = 7;
                            match_key = Ternary { value = Bigint.of_int 167772673;
                                                  mask = Bigint.of_int 4294967295 } } ;
                          { field_id = 8;
                            match_key = Ternary { value = Bigint.of_int 17;
                                                  mask = Bigint.of_int 255 } }];
               action = Action { action_id = 23623126;
                                 args = [ { arg_id = 1;
                                            value = Bigint.of_int 401 } ] };

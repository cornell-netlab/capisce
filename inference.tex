...
For actions, we restrict the language to be generated by only non-symbolic
assignment, sequence, and $\SKIP$.
...
\begin{proof}
  ...
  \item[$(c = t.\apply())$]
    ...
    \item[\textsc{Hit}] In this case, there is some $r_i$ such that $\pkt,\mu
      ...
      Since $\rho$ doesn't occur in $c$, then also

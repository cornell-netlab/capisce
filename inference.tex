...
\begin{definition}[Projections]
  ...
  are $S$-equivalent, written $P =_S P'$ iff $P \subseteq_S P'$ and $P \subseteq_S P'$.
\end{definition}

\begin{lemma}[Projection]
  For $c \in \Cmd$, $\fvs(c) \subseteq V \subseteq \Var$ and $P \subseteq \Pkt$ such that $\forall
  \pkt_1,\pkt_2 \in P, \pkt_1 =_V \pkt_2$, $\denote{c} P =_V \denote{c} P|_V$.
  ...
  \item[$(c = t.\apply())$] Let $\pkt$ and $\sigma$ be arbitrary. Let
    ...
    \item[\textit{Case 1}.] Assume that there is some $1 \leq i \leq n$ such
      ...
      \[\bigcup_{a=0}^{|t.\action| - 1}\denote{t.\action[a](\rho_t.\data)}^\dagger H_a
       = \denote{t.\action[r_i.\action](r_i.\data)}^\dagger H_a
       \]

       Which is $V$-equivalent to $\denote{t.\action[r_i.\action](r_i.\data)}\,\pkt$. \todo{PROVE THIS LEMMA}
       The result follows by the IH on $t.\action[r_i.\action](r_i.\data)$.
     ...
     \item[\text{Case 2}.]Assume that there is no $1 \leq i \leq n$ such that
       ...
       $M \cup\bigcup_{a=0}^{|t.\action|-1}\denote{t.\action[a](\rho_t.\data)} H_a$ is $V$-equal to this $\{\pkt\}$.
        ...
        1$. Conclude that $H_a = \emptyset$ and $M \neq \emptyset$. Since $P =_V
        \{\pkt\}$, and $M$ is a nonempty refinement of $P$\todo{PROVE THIS
          LEMMA?}, conclude that $M =_V \{\pkt\}$. The result follows.
    \end{enumerate}

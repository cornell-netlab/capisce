...
control process_rewrite(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".rewrite_ipv4_multicast") action rewrite_ipv4_multicast() {
        hdr.ethernet.dstAddr = ((bit<48>) hdr.ethernet.dstAddr)[47:23]
                               ++ ((bit<48>)hdr.ipv4.dstAddr)[22:0];
    }
...
control process_int_insertion(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".int_transit") action int_transit(bit<32> switch_id) {
        ...
        meta.int_metadata.insert_byte_cnt = meta.int_metadata.instruction_cnt << 16w2;
...
control process_egress_l4port(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".egress_l4_dst_port") table egress_l4_dst_port {
        ...
        key = {
            meta.l3_metadata.egress_l4_dport: ternary;
        }
        size = 512;
    }
    @name(".egress_l4_src_port") table egress_l4_src_port {
        ...
        key = {
            meta.l3_metadata.egress_l4_sport: ternary;
        }
        size = 512;
    }
...
control process_tunnel_encap(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".f_insert_nvgre_header") action f_insert_nvgre_header() {
        ...
        hdr.nvgre.flow_id = ((bit<8>)meta.hash_metadata.entropy_hash)[7:0];
    }
...
control process_global_params(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_config_parameters") action set_config_parameters(bit<1> enable_dod) {
        ...
        random(meta.ingress_metadata.sflow_take_sample, (bit<32>)32w0, 32w0x7fffffff);
    }
...
control process_int_endpoint(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".int_sink_gpe") action int_sink_gpe(bit<32> mirror_id) {
        meta.int_metadata.insert_byte_cnt = meta.int_metadata.gpe_int_hdr_len << 16w2;
        int_sink(mirror_id);
    }
...
control process_hashes(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".compute_lkp_ipv4_hash") action compute_lkp_ipv4_hash() {
        // hash(meta.hash_metadata.hash1, crc_poly(17w98309, true, false), (bit<16>)16w0, { meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)32w65536);
        // hash(meta.hash_metadata.hash2, crc_poly(17w98309, true, false), (bit<16>)16w0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv4_metadata.lkp_ipv4_sa, meta.ipv4_metadata.lkp_ipv4_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)32w65536);
    }
    @name(".compute_lkp_ipv6_hash") action compute_lkp_ipv6_hash() {
        // hash(meta.hash_metadata.hash1, crc_poly(17w98309, true, false), (bit<16>)16w0, { meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)32w65536);
        // hash(meta.hash_metadata.hash2, crc_poly(17w98309, true, false), (bit<16>)16w0, { meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, (bit<32>)32w65536);
    }
    @name(".compute_lkp_non_ip_hash") action compute_lkp_non_ip_hash() {
        // hash(meta.hash_metadata.hash2, crc_poly(17w98309, true, false), (bit<16>)16w0, { meta.ingress_metadata.ifindex, meta.l2_metadata.lkp_mac_sa, meta.l2_metadata.lkp_mac_da, meta.l2_metadata.lkp_mac_type }, (bit<32>)32w65536);
    }
...
control process_mac_learning(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".generate_learn_notify") action generate_learn_notify() {
        // digest<mac_learn_digest>((bit<32>)321024, { meta.ingress_metadata.bd, meta.l2_metadata.lkp_mac_sa, meta.ingress_metadata.ifindex });
    }

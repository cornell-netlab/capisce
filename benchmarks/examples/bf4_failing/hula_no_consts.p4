...
parser MyParser(packet_in packet,
    ...
    state parse_hula {
        ...
        transition parse_srcRouting0;
    }

    state parse_srcRouting0 {
    ...
    state parse_srcRouting2 {
        packet.extract(hdr.srcRoutes[2]);
    ...
    state parse_srcRouting3 {
        packet.extract(hdr.srcRoutes[3]);
        transition select(hdr.srcRoutes[3].bos) {
            1w1       : parse_ipv4;
            default : parse_srcRouting4;
        }
    }
    state parse_srcRouting4 {
        packet.extract(hdr.srcRoutes[4]);
        transition select(hdr.srcRoutes[4].bos) {
            1w1       : parse_ipv4;
            default : parse_srcRouting5;
        }
    }
    state parse_srcRouting5 {
        packet.extract(hdr.srcRoutes[5]);
        transition select(hdr.srcRoutes[5].bos) {
            1w1       : parse_ipv4;
            default : parse_srcRouting6;
        }
    }
    state parse_srcRouting6 {
        packet.extract(hdr.srcRoutes[6]);
        transition select(hdr.srcRoutes[6].bos) {
            1w1       : parse_ipv4;
            default : parse_srcRouting7;
        }
    }

(*test.FabricIPv4UnicastAclOuterDropTest*)
open Runtime
...
let test = [
  TableEntry { table_id = 44104738;
               matches = [{ field_id = 6;
                          ...
                          { field_id = 11;
                            match_key = Ternary { value = Bigint.of_int 5061;
                                                  mask = Bigint.of_int 65535 } } ;
                          { field_id = 12;
                            match_key = Ternary { value = Bigint.of_int 5060;
                                                  mask = Bigint.of_int 65535 } }];
               action = Action { action_id = 23570973; args = [] };
               priority = 10 };

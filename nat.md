...
bf4 reported finding 5 bugs, and not being able to fix 2 of them. 
I think the following should hold for just uninitialized reads.
...
ρ_ipv4_lpm.action == set_nhop

ρ_if_info.action = set_if_info

```

Some additional bugs come from "egress spec not set", and this formula certainly requires inter-table communication

```

```

and also from "adding a header that is already valid", which we can fix by never cloning packets 

```
ρ_nat.action != nat_miss_int_to_ext
```
...
### What do we get when we only instrument for determined forwarding
...
(forall ((cpu_header__if_index (_ BitVec 9))
  ...
  (let ((a!1 (and (or (not (= row_forward__action #b0))
        ...
        (a!6 (= (bvnot (bvor (bvnot meta__ipv4_da)
                ...
                (bvnot (bvor (bvnot row_ipv4_lpm__meta_ipv4)
                             (bvnot row_ipv4_lpm__meta_ipv4Mask)))))
        (a!12 (= (bvand tcp__dstPort row_nat__dstPortMask) (bvand row_nat__dstPort row_nat__dstPortMask)))
        (a!14 (= (bvand tcp__srcPort row_nat__tcp__srcPortMask) (bvand row_nat__tcp__srcPort row_nat__tcp__srcPortMask)))
  ...
  (let ((a!9 (and (or (not (= ipv4__ttl #x00)) a!8) (not (= ipv4__ttl #x00))))
        ...
        (a!29 (and (or (not (= ipv4__ttl #x00)) a!28)
                   (or (not (= ipv4__ttl #x00))
                       (= standard_metadata__egress_spec #b000000000))
                   (= standard_metadata__egress_spec #b000000000))))
  (let ((a!10 (not (= meta__do_forward #b1)))
        (a!25 (and (or (not (= meta__do_forward #b1)) a!24)
                   (or (not (= meta__do_forward #b1))
                       (= standard_metadata__egress_spec #b000000000)))))
  (let ((a!11 (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                   (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                   (not (= row_nat__action #b011))
                   (not (= row_nat__action #b100))
                   (not (= row_nat__action #b101))))
  ...
  (let ((a!13 (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                            (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                            (not (= row_nat__action #b011))
                            (not (= row_nat__action #b100))
                            (not (= row_nat__action #b101)))
                       ...
                       (not (= row_nat__dstPortMask #x00000000)))
                   (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                            (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                            (not (= row_nat__action #b011))
                            (not (= row_nat__action #b100))
                            (not (= row_nat__action #b101)))
        ...
        (a!31 (and (or (not (= ghost_nat__miss #b0))
                   ...
                   (or (not (= ghost_nat__miss #b0))
                       ...
                       (not a!12)
                       a!30))))
  (let ((a!15 (and (or (not (= row_nat__tcp__srcPortMask #x00000000)) 
                       (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                     (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                                     (not (= row_nat__action #b011))
                                     (not (= row_nat__action #b100))
                                     (not (= row_nat__action #b101)))
                            ...
                            (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                ...
                                (not (= row_nat__dstPortMask #x00000000))
                                (not a!12))))
                   (or (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                     (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                                     (not (= row_nat__action #b011))
                                     (not (= row_nat__action #b100))
                                     (not (= row_nat__action #b101)))
    ...
    (let ((a!36 (and (or a!20
        ...
        (a!41 (and (or (not (= meta__is_ext_if row_nat__meta__is_ext_if))
                   ...
                   (or (not (= row_if_info__data__is_ext
                       ...
                       (not (= row_if_info__action #b1))
                       a!40)))        
        (a!47 (and (=> (= meta__is_ext_if row_nat__meta__is_ext_if)
                       (= row_if_info__action #b0)
                       a!45)
                   (=> (= row_if_info__data__is_ext row_nat__meta__is_ext_if))
                       (= row_if_info__action #b1)
                       a!46)))
  
     (and (=> (= ghost_if_info__miss #b0)
              (= row_if_info__meta__if_index cpu_header__if_index)
              (and (=> (= meta__is_ext_if row_nat__meta__is_ext_if)
                       (= row_if_info__action #b0)
                       (and (or (not (= row_nat__tcp__isValid #b1))
                                (not (= row_nat__ipv4__isValid #b1)))
                                (or (not (= ghost_nat__miss #b1)) a!10)
                                (and (or (not (= row_nat__ipv4__srcAddrMask #x00000000)) 
                                         (and (or (not (= row_nat__ipv4__dstAddrMask #x00000000)) 
                                                  (and (or (not (= row_nat__tcp__srcPortMask #x00000000)) 
                                                           (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                         (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                                                                         (not (= row_nat__action #b011))
                                                                         (not (= row_nat__action #b100))
                                                        ...
                                                        (or (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                 ...
                                                                 (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                          ...
                                                                          (not a!12)))
                                                            (not (= row_nat__tcp__srcPortMask #x00000000))
                                                            (not (= (bvand tcp__dstPort row_nat__dstPortMask) (bvand row_nat__dstPort row_nat__dstPortMask))))))
                                              (or (not (= row_nat__ipv4__dstAddrMask #x00000000)) 
                                                  (and (or (not (= row_nat__tcp__srcPortMask #x00000000)) 
                                                           (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                         (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                                                  ...
                                                  (not (= row_nat__ipv4__dstAddrMask #x00000000))
                                                  (not a!16))))
                                     (or (and (or (not (= row_nat__ipv4__dstAddrMask #x00000000)) 
                                                  (not (= row_nat__ipv4__dstAddrMask #x00000000)) 
                                                  (and (or (not (= row_nat__tcp__srcPortMask #x00000000)) 
                                                           (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                         (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                                                        ...
                                                        (or (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                 ...
                                                                 (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                          ...
                                                                          (not (= (bvand tcp__dstPort row_nat__dstPortMask) (bvand row_nat__dstPort row_nat__dstPortMask)))))
                                                            (not (= row_nat__tcp__srcPortMask #x00000000))
                                                            (not (= (bvand tcp__srcPort row_nat__tcp__srcPortMask) (bvand row_nat__tcp__srcPort row_nat__tcp__srcPortMask)))))))
                                                  (or (not (= row_nat__ipv4__dstAddrMask #x00000000)) 
                                                      (and (or (not (= row_nat__tcp__srcPortMask #x00000000)) 
                                                           (and (or (and (or (not (= row_nat__action #b000)) (not (= meta__do_forward #b1)))
                                                                         (or (not (= row_nat__action #b001)) (not (= meta__do_forward #b1)))
                   ...
                   (=> (= row_if_info__data__is_ext row_nat__meta__is_ext_if)
                       (= row_if_info__action #b1)
                       (and (=> (= row_nat__tcp__isValid #b1)
                                (= row_nat__ipv4__isValid #b1)
                                a!34)
                            (=> (= ghost_nat__miss #b1) 
                                a!25))))))

              
          (=> (= ghost_if_info__miss #b0)
              (= row_if_info__meta__if_index cpu_header__if_index)
              a!41)
          (=> (= ghost_if_info__miss #b0)
              (= row_if_info__meta__if_index cpu_header__if_index)
              a!47)
          (=> (= ghost_if_info__miss #b0)
              (= row_if_info__meta__if_index standard_metadata__ingress_port)
              a!36)
          (=> (= meta__is_ext_if row_nat__meta__is_ext_if)
                  (= ghost_if_info__miss #b1)
                  a!35)
          (=> (= ghost_if_info__miss #b0)
              (= row_if_info__meta__if_index standard_metadata__ingress_port)
              a!41)
